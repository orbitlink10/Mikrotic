...
@php
    ...
    $fullPageTitle = \Illuminate\Support\Str::contains($articleTitle, config('app.name', 'Solar Flood Lights Kenya'))
        ? $articleTitle
        : $articleTitle . ' | ' . config('app.name', 'Solar Flood Lights Kenya');
